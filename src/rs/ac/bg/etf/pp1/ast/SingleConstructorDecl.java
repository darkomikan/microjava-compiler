...
public class SingleConstructorDecl extends ConstructorDeclListNoE {

    private ConstructorDecl ConstructorDecl;

    public SingleConstructorDecl (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleConstructorDecl(\n");
