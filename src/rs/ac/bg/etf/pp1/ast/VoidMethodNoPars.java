...
public class VoidMethodNoPars extends MethodDecl {

    private MethodVoidName MethodVoidName;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public VoidMethodNoPars (MethodVoidName MethodVoidName, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VoidMethodNoPars(\n");
