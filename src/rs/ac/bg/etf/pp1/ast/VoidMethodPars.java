...
public class VoidMethodPars extends MethodDecl {
    ...
    public VoidMethodPars (MethodVoidName MethodVoidName, FormPars FormPars, VarDeclList VarDeclList, StatementList StatementList) {
